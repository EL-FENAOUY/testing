...
def load_preprocessor():
    preproc = pickle.load(open("C:/Users/lenovo/sabrine_saidi/Projet7-Openclassrooms-main/modules_api/preprocessor.sav", 'rb'))
    return preproc
...
def load_model(model_to_load):
    if model_to_load == "randomForest":
        model = pickle.load(open("C:/Users/lenovo/sabrine_saidi/Projet7-Openclassrooms-main/modules_api/classifier_rf_model.sav", 'rb'))
    elif model_to_load == "lgbm":
        model = pickle.load(open("C:/Users/lenovo/sabrine_saidi/Projet7-Openclassrooms-main/modules_api/classifier_lgbm_model.sav", 'rb'))
    else:
